<template>
    <div class="about-page-wrapper">
        <Card :bordered="false">
            ...
            <p>应用版本: {{version}}</p>
            <p>创建时间: {{create_at}}</p>
            <p>应用部署在coding page / github pages</p>
            <p>本应用使用vue + vue-router等vue生态技术栈开发</p>
            <p>应用定位为纯本地的简单干净移动端导航页,不用注册不用登陆</p>
            <p>最初的开发目的视为了满足自己使用需求,如果恰好也帮助了你,希望你用的高兴</p>
        </Card>
        <Card :bordered="false">
            <p slot="title">关于作者</p>
...
export default {
    ...
    data () {
        return {
            ...
            create_at: package_json.create_at,
        }
    },
    methods: {
        goBack() {
